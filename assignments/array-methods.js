...
ticketPriceTotal = runners.reduce((total, donation) => {
...
// Problem 1: Use .reduce() to determine the the average donation made by each runner

// Problem 2: Use .filter() to count the number of 'M' shirts required.

// Problem 3: Use .map() to make a new array for all the email addresses